  ...
  return (
      ...
      />
        ...
        <TextContainer
           ...
           transition={{duration:1,delay:1}}
        >
          <Title>Levelup your social life</Title>
          <Text>
          Because who needs real achievements when you can bond with a lamppost? Transform your life by connecting with randoms and nearby spots 
          </Text>
        <Button onClick={()=>{
