...
const FourthSection = () => {
  ...
  return (
      ...
      />
        ...
        >
          <Title>The Next level social networking </Title>
          <Text>
          Imagine a social network that transcends the digital realm, weaving gamification into the fabric of everyday life. It's the dawn of a new era for social connection.
          </Text>
          <Button onClick={()=>{
