...
const SecondSection = () => {
  ...
  return (
      ...
      <Section >
        ...
        >
          <Title>Flex your TagScores
</Title>
          <Text>
          Forget buried stats! Your TagScore explodes with every point, showcasing your social adventures and explored places.  It's a profile centerpiece - conversation starter, status symbol, and mini-travelogue in one.  Get ready to flex and inspire friendly competition!
          </Text>
        </TextContainer>
        </Wrapper>
      </Section>
