...
const PlaceholderText = `
 Answer will be added soon. Tagsocial is under construction.
`
  ...
  return (
    ...
    >
      ...
      <FaqAccordionItem
        ...
        >
          <FaqAccordionControl>
            How does Tagsocial respect my privacy?
          </FaqAccordionControl>
          <FaqAccordionPanel>{PlaceholderText}</FaqAccordionPanel>
        </FaqAccordionItem>
        ...
        >
          <FaqAccordionControl>
            How Tagsocial is different from other social networking platforms?
          </FaqAccordionControl>
          <FaqAccordionPanel>{PlaceholderText}</FaqAccordionPanel>
        </FaqAccordionItem>
